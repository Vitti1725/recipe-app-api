...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_tag(self):
        ...
        tag_indian = Tag.objects.create(user=self.user, name='South-Indian')
        payload = {
            'title': 'Pongal',
            'time_minutes': 30,
            'price': Decimal('2.50'),
    ...
    def test_craete_recipe_with_existing_ingredient(self):
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Garlic Bread')
        r2 = create_recipe(user=self.user, title='Pizza')
        in1 = Ingredient.objects.create(user=self.user, name='Garlic')
        in2 = Ingredient.objects.create(user=self.user, name='Cheese')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Choco Lava Cake')
    ...
    def test_filter_by_tags(self):
        """Test filtering recipes by tags."""
        r1 = create_recipe(user=self.user, title='Uttapam')
        r2 = create_recipe(user=self.user, title='Chole Bhature')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            ...
            img.save(image_file, forat='JPEG')
            image_file.seek(0)
